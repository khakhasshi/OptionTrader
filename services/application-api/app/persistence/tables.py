...
llm_reviews = Table(
    ...
    Column("unavailable_reason_code", Text),
    Column("latency_ms", Integer, nullable=False),
    Column("attempts", Integer, nullable=False),
    Column("cache_hit", Boolean, nullable=False),
    Column("input_tokens", Integer, nullable=False),
    Column("output_tokens", Integer, nullable=False),
    Column("estimated_cost_usd", Numeric, nullable=False),
    CheckConstraint("latency_ms >= 0", name="ck_llm_latency_nonnegative"),
    CheckConstraint("attempts >= 0 AND attempts <= 4", name="ck_llm_attempts_bounded"),
    schema="review",
)
...
rule_hypotheses = Table(
    ...
    Column("payload", _JSON, nullable=False),
    Column("created_at_utc", DateTime(timezone=True), nullable=False),
    CheckConstraint("activation_allowed = false", name="ck_rule_hypothesis_no_activation"),
    schema="review",
)
